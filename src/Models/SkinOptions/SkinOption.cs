            ...
            Children = new SkinOption[]
            {
                ...
                new ParentSkinOption
                {
                    ...
                    Children = new SkinOption[]
                    {
                        ...
                        new SkinManiaKeysOption(1),
                        new SkinManiaKeysOption(2),
                        new SkinManiaKeysOption(3),
                        new SkinManiaKeysOption(4),
                        new SkinManiaKeysOption(5),
                        new SkinManiaKeysOption(6),
                        new SkinManiaKeysOption(7),
                        new SkinManiaKeysOption(8),
                        new SkinManiaKeysOption(9),
                    },
                },
